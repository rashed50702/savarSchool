...
class StudentAttendancesController extends Controller
{
    ...
    {
        return view('attendance.student.attendance-add-search-form', [
    ...
    {
         return view('attendance.student.attendance-monthly-search-form', [
            // 'subjects' => Subject::with('academicClass')->orderBy('class_id','ASC')->paginate(15)
         ]);   
    }
    ...
    {
         return view('attendance.student.attendance-report-search-form', [
            // 'subjects' => Subject::with('academicClass')->orderBy('class_id','ASC')->paginate(15)
         ]);   
    }
}
