                    ...
                    @foreach($classes as $key=>$value)
                        <tr class="{{$value->id}}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{!! route('classes.destroy',$value->id )!!}" class="delete btn btn-danger btn-xs deleteBtn btnColor"  data-token="{!! csrf_token() !!}" data-id="{!! $value->id !!}" title="delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    @endif
