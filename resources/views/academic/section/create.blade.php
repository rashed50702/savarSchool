            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="{{ route('classes.index') }}"><span style=" margin-top: -33px;" class="btn btn-primary btn-flat btn-sm pull-right"><i class="fa fa-list-ul" aria-hidden="true"></i> Class Sections List</span></a>
                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="section_name" class="control-label">Section Name <span class="star"><i class="fa fa-star"></i></span></label>
                                                        <input type="text" name="name" v-model="name" class="form-control" :class="{ 'is-danger':errors.name }" id="name" placeholder="Section Name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('sections.index') }}" class="btn btn-danger"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
