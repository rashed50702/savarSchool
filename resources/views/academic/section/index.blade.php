    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="{{ route('sections.create') }}"><span style=" margin-top: -33px;" class="btn btn-primary btn-flat btn-sm pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add New Section</span></a>
            </div>
                    ...
                    @foreach($sections as $key=>$value)
                        <tr class="{{$value->id}}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{!! route('sections.destroy',$value->id )!!}" class="delete btn btn-danger btn-xs deleteBtn btnColor"  data-token="{!! csrf_token() !!}" data-id="{!! $value->id !!}" title="delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    @endif
