            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="{{ route('testimonials.index') }}"><span style=" margin-top: -33px;" class="btn btn-primary btn-flat btn-sm pull-right"><i class="fa fa-list-ul" aria-hidden="true"></i> Testimonials</span></a>
                    </div>
                        ...
                        <form method="POST" id="adding-section" action="#" @submit.prevent="addSection()">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><p>New testimonial</p></div>
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 certificate">
                                                    ...
                                                    <p>So far as I know he/she was not involved in any  activity subvervise of the state or of discipline of the institution. He/she bears a good moral character.</p>
