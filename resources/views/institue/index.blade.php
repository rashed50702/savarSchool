    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="{{ route('institues.create') }}"><span style=" margin-top: -33px;" class="btn btn-primary btn-flat btn-sm pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add New Institute</span></a>
            </div>
            <div class="panel-body">
                <table id="datatable" class="table table-striped table-bordered" style="color: black">
                    ...
                    <tr class="">
                        <td>1</td>
                        <td>Alimuddin High School</td>
                        <td>Mirpur, Dhaka-1215</td>
                        <td>Shakir Ullah</td>
                        <td>+880174562841</td>
