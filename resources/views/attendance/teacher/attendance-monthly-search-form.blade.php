                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" id="adding-class" action="{!! route('classes.store') !!}" @submit.prevent="addClass()">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><p>Monthly Attendance Report</p></div>
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="monthName" class="control-label">Select Month <span class="star"><i class="fa fa-star"></i></span></label>
                                                        <select name="monthName" v-model="monthName" id="monthName" class="form-control">
